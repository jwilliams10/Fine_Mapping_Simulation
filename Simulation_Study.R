...
load("Fine_Mapping_Simulation/Data/Sim1_Y.Rdata")
...
Sim1_Fam <- read.table("Fine_Mapping_Simulation/Data/Sim1.fam", quote="\"", comment.char="")
Sim1_Fam[,1] <- 0
write.table(Sim1_Fam,"Fine_Mapping_Simulation/Data/Sim1.fam", col.names = FALSE,row.names = FALSE)

G_Sim1 <- common_variants_Sim1$genotypes[,1:dim(common_variants_Sim1$genotypes)[2]]

load("Fine_Mapping_Simulation/Data/Sim2_Y.Rdata")
...
for(i in 1:50){
  ...
  # write.table(Y_Sim1[[i]],file = "Fine_Mapping_Simulation/Data/Y_Sim1.txt",sep = '\t',row.names = FALSE,quote = FALSE)
  # 
  # system("/data/williamsjacr/software/plink2 --bfile Fine_Mapping_Simulation/Data/Sim1 --pheno Fine_Mapping_Simulation/Data/Y_Sim1.txt --pheno-name Y --linear allow-no-covars --vif 999 --out Fine_Mapping_Simulation/Data/Sim1_SumStats")
  # 
  # Sim1_SumStats <- read.delim("Fine_Mapping_Simulation/Data/Sim1_SumStats.Y.glm.linear", header=FALSE, comment.char="#")
  ...
  dir <- "Fine_Mapping_Simulation/Data/"
  ...
  system(paste0("/data/williamsjacr/software/finemap_v1.4.2_x86_64/./finemap_v1.4.2_x86_64 --sss --in-files Fine_Mapping_Simulation/Data/Sim1_FINEMAP"))
  
  output <- read.csv("Fine_Mapping_Simulation/Data/Sim1_FINEMAP.snp", sep="")
  
  output <- cbind(Sim1_Bim,output$prob)
  results_FINEMAP_pip_Sim1[[i]] <- output
  
  output <- read.table("Fine_Mapping_Simulation/Data/Sim1_FINEMAP.cred1", header=TRUE, quote="\"")
  system("rm Fine_Mapping_Simulation/Data/Sim1_FINEMAP.cred1")
  cs <- as.numeric(gsub("rs","",output$cred1))
  if(file.exists("Fine_Mapping_Simulation/Data/Sim1_FINEMAP.cred2")){
    output <- read.table("Fine_Mapping_Simulation/Data/Sim1_FINEMAP.cred2", header=TRUE, quote="\"")
    system("rm Fine_Mapping_Simulation/Data/Sim1_FINEMAP.cred2")
  ...
  system(paste0("/data/williamsjacr/software/finemap_v1.4.2_x86_64/./finemap_v1.4.2_x86_64 --sss --in-files Fine_Mapping_Simulation/Data/Sim2_FINEMAP"))
  
  output <- read.csv("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.snp", sep="")
  
  output <- cbind(Sim2_Bim,output$prob)
  results_FINEMAP_pip_Sim2[[i]] <- output
  
  
  output <- read.table("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred2", header=TRUE, quote="\"")
  system("rm Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred2")
  cs <- as.numeric(gsub("rs","",output$cred1))
  if(file.exists("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred1")){
    output <- read.table("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred1", header=TRUE, quote="\"")
    system("rm Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred1")
    cs <- c(cs,as.numeric(gsub("rs","",output$cred1)))
  }
  if(file.exists("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred3")){
    output <- read.table("Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred3", header=TRUE, quote="\"")
    system("rm Fine_Mapping_Simulation/Data/Sim2_FINEMAP.cred3")
    cs <- c(cs,as.numeric(gsub("rs","",output$cred1)))
  }
...
save(results_susie_rss_pip_Sim1,results_susie_rss_cs_Sim1,results_FINEMAP_pip_Sim1,results_FINEMAP_cs_Sim1,file = "Fine_Mapping_Simulation/Data/Sim1_Result.RData")
save(results_susie_rss_pip_Sim2,results_susie_rss_cs_Sim2,results_FINEMAP_pip_Sim2,results_FINEMAP_cs_Sim2,file = "Fine_Mapping_Simulation/Data/Sim2_Result.RData")
